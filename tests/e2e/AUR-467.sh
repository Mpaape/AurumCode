#!/usr/bin/env bash
#
# E2E program for card AUR-467, selector E2EAUR467.
#
...
#   -- the package this card owns. tests/acceptance/AUR-467.sh::AC-001 and
#   tests/unit/AUR-467.go already prove them directly against
...
run_dir="$(mktemp -d "${TMPDIR:-/tmp}/aurum-e467.XXXXXX")" || infra mktemp
