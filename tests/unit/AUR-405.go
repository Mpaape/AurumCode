...
const fakeScmSchemaPath405 = ".board/schemas/fake-scm-offline-profile.schema.json"
const fakeScmLockPath405 = ".board/locks/oci/fake-scm-offline-v1.lock.json"
const ociConformanceSchemaPath405 = ".board/schemas/oci-conformance-profile.schema.json"
const ociConformanceLockPath405 = ".board/locks/oci/oci-conformance-v1.lock.json"
const polyglotSchemaPath405 = ".board/schemas/polyglot-toolchain-profile.schema.json"
const polyglotLockPath405 = ".board/locks/oci/polyglot-toolchain-v1.lock.json"
...
var registryKeys405 = []string{"bootstrap-readonly-v1", "docs-tool-offline-v1", "fake-provider-v1", "fake-scm-offline-v1", "go-git-offline-v1", "go-unit-offline-v1", "oci-conformance-v1", "parser-worker-v1", "polyglot-toolchain-v1", "registry-v1", "sqlite-offline-v1"}
...
// ValidateRegistryAUR405 resolves the canonical registry and admits exactly the eleven
...
func ValidateRegistryAUR405(root string) (string, string) {
	...
	for _, x := range r.Profiles {
		...
		case "fake-scm-offline-v1":
			...
			if x.Schema != fakeScmSchemaPath405 || x.Lock != fakeScmLockPath405 {
				return "", "unsafe-plan"
			}
			if !digest405.MatchString(x.SchemaDigest) || !digest405.MatchString(x.LockDigest) || !digest405.MatchString(x.ImageSetDigest) {
				return "", "digest-invalid"
		...
		case "oci-conformance-v1":
			...
			if x.Schema != ociConformanceSchemaPath405 || x.Lock != ociConformanceLockPath405 {
				return "", "unsafe-plan"
			}
			if !digest405.MatchString(x.SchemaDigest) || !digest405.MatchString(x.LockDigest) || !digest405.MatchString(x.ImageSetDigest) {
				return "", "digest-invalid"
		...
		case "polyglot-toolchain-v1":
			...
			if x.Schema != polyglotSchemaPath405 || x.Lock != polyglotLockPath405 {
				return "", "unsafe-plan"
			}
			if !digest405.MatchString(x.SchemaDigest) || !digest405.MatchString(x.LockDigest) || !digest405.MatchString(x.ImageSetDigest) {
				return "", "digest-invalid"
