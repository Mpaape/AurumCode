...
expected_csv='AUR-377,AUR-378,AUR-379,AUR-380,AUR-381,AUR-382'
suite="$repo_root/tests/gates/legacy/AUR-313/suite.tsv"
[[ -s "$suite" && ! -L "$suite" ]] || fail document_manifest_missing
