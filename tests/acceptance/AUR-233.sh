...
expected_csv='AUR-359,AUR-360,AUR-361,AUR-362,AUR-363,AUR-364'
suite="$repo_root/tests/gates/bootstrap/AUR-233/suite.tsv"
[[ -s "$suite" && ! -L "$suite" ]] || fail lock_domain_missing
