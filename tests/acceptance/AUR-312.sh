...
expected_csv='AUR-365,AUR-366,AUR-367,AUR-368,AUR-369,AUR-370,AUR-371,AUR-372,AUR-373,AUR-374,AUR-375,AUR-376'
suite="$repo_root/tests/gates/legacy/AUR-312/suite.tsv"
[[ -s "$suite" && ! -L "$suite" ]] || fail script_manifest_missing
