...
// StubEstimator is a test-only implementation of TokenEstimator used across
// this package's tests. It never shipped in production in the original
// engine either (it lived only in this _test.go file, see AUR-430's
// restoration audit) -- the production default is HeuristicEstimator in
// estimator.go.
